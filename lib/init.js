...
exports.setUp = function(callback) {
	...
	// Getting the settings from the file that should exist.
	try {
	...
	console.log(globalVars.settings);
	
	// Stops the script running if the file cannot be loaded.
	if (!globalVars.settings) {
		loggingFuncs.logMessage(null, 'There are issues loading the settings.json file.');
		process.exit();
	}
