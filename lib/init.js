...
exports.setUp = function(callback) {
	...
	async.whilst(
		...
		function(callback) {
			...
			globalVars.preferredGameHostLength[loginDetails[i].team] = (!isNaN(loginDetails[i].preferredGameHostLength)) ? loginDetails[i].preferredGameHostLength*60000 : 7200000;
			globalVars.nonPreferredGameHostLength[loginDetails[i].team] = (!isNaN(loginDetails[i].nonPreferredGameHostLength)) ? loginDetails[i].nonPreferredGameHostLength*60000 : 1800000;
			globalVars.hostTrainMessage[loginDetails[i].team] = (_.isString(loginDetails[i].hostTrainMessage)) ? loginDetails[i].hostTrainMessage : null;
			globalVars.modsAreAdmins[loginDetails[i].team] = (_.isBoolean(loginDetails[i].modsAreAdmins)) ? loginDetails[i].modsAreAdmins : false;
