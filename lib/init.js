...
function connectWhispers(team, ircOptions, callback) {
	...
	// Will quit the application is whispers haven't connected after 30 seconds.
	// (Sometimes it can't connect and never tries again for some reason.)
	var noConnectionTimeout = setTimeout(function() {
		loggingFuncs.logMessage(null, 'Cannot connect whispers; quitting. Try running me again!');
		process.exit();
	}, 30000);
