...
exports.setUp = function() {
	...
	dispatcher.onGet("/", function(req, res) {
		...
		var html = '<b>Current Version:</b> ' + globalVars.version;
		if (globalVars.newVersion) {html += '<br><b>Latest Version:</b> <a href="https://github.com/zoton2/Twitch-Team-Hosting-Bot/releases/latest">' + globalVars.newVersion + '</a>';}
		
		// API endpoint links.
		html += '<br><br><b>API Endpoints</b><br>' +
