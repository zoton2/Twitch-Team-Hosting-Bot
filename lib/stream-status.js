...
exports.setUpHostChecking = function(team) {
	...
	globalVars.client[team].on('hosting', function(channel, target, viewers) {
		// Checks if this hosting event is for the channel we are currently hosting.
		if (target.toLowerCase() !== globalVars.currentHostedChannel[team].username
			...
			// Sets up a timeout to remove the channel from the list after 30 minutes.
